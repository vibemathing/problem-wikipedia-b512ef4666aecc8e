...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-b512ef4666aecc8e"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-b512ef4666aecc8e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-b512ef4666aecc8e",
        "url": "https://en.wikipedia.org/wiki/Schinzel%27s_hypothesis_H"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Schinzel's hypothesis H that for every finite collection $\\{f_{1},\\ldots ,f_{k}\\}$ of nonconstant irreducible polynomials over the integers with positive leading coefficients, either there are infinitely many positive integers $n$ for which $f_{1}(n),\\ldots ,f_{k}(n)$ are all primes , or there is some fixed divisor $m>1$ which, for all $n$ , divides some $f_{i}(n)$ .",
      "version": 1
    },
    "title": "Schinzel's hypothesis H",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "079963bb37ed3c332b2aebb36fadec56d7bb79d7d3cfc53483352ed9727b78f4"
}
```
